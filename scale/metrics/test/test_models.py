...
class TestMetricsIngest(TestCase):
    ...
    def test_calculate_filtered(self):
        ...
        ingest_test_utils.create_ingest(status='DEFERRED', ingest_ended=datetime.datetime(2015, 1, 1, tzinfo=utc))
        ingest_test_utils.create_ingest(status='INGESTED', ingest_ended=datetime.datetime(2015, 1, 1, tzinfo=utc))
        ingest_test_utils.create_ingest(status='ERRORED', ingest_ended=datetime.datetime(2015, 1, 1, tzinfo=utc))
        ingest_test_utils.create_ingest(status='DUPLICATE', ingest_ended=datetime.datetime(2015, 1, 1, tzinfo=utc))
